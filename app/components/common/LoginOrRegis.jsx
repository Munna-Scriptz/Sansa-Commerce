...
const LoginOrRegis = ({HideByLink}) => {
  return (
    <section className='flex items-center justify-center'>
        <div className='w-[600px] h-[500px] bg-brand overflow-hidden relative z-[999] p-5 rounded-[7px] shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)]'>
            <div className=' bg-primary w-[315px] h-[800px] rotate-[38deg] absolute top-[-183px] left-[-136px] z-[-1]'></div>
