...
const SingleSearchPro = ({img}) => {
  return (
    <>
        <div className='md:w-[308px] lg:w-[310px] border-1 border-gray-300 p-6 rounded-[8px] relative'>
            <Image src={img} alt='Image'></Image>
            <h2 className='text-second text-[24px] mt-6 mb-2'>Warning t-shirt</h2>
            <p className='text-subText text-sm'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Inventore, enim?</p>
            {/* ----Price  */}
